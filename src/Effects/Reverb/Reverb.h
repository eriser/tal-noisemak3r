...
public:
	Reverb(int sampleRate)
	{
		...
		preAllPassFilterL = new AllPassFilter(14.0f,  0.68f, sampleRate);
		preAllPassFilterR = new AllPassFilter(15.0f,  0.68f, sampleRate);

		postAllPassFilterL = new AllPassFilter(40.0f,  0.68f, sampleRate);
		postAllPassFilterR = new AllPassFilter(38.0f,  0.68f, sampleRate);
